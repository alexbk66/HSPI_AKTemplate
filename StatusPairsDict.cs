...
{
    using PairStatusControlDict = Dictionary<ePairStatusControl, List<MyPair>>;
    using ValueCAPIDict = Dictionary<double, CAPI.CAPIControl>;
    using MyPairList = List<MyPair>;
    ...
    /// </summary>
    class StatusPairsDict : Dictionary<SplitRangeType, PairStatusControlDict>
    {
